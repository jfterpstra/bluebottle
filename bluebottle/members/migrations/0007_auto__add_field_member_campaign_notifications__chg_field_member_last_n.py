...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.campaign_notifications'
        db.add_column(u'members_member', 'campaign_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Member.last_name'
        db.alter_column(u'members_member', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Member.first_name'
        db.alter_column(u'members_member', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Member.campaign_notifications'
        db.delete_column(u'members_member', 'campaign_notifications')


        # Changing field 'Member.last_name'
        db.alter_column(u'members_member', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Member.first_name'
        db.alter_column(u'members_member', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'members.useraddress': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'address'", 'unique': 'True', 'to': u"orm['members.Member']"})
        },
        u'taggit.tag': {
