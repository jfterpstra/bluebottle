...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.order_type'
        db.alter_column(u'orders_order', 'order_type', self.gf('django.db.models.fields.CharField')(max_length='100'))

    def backwards(self, orm):

        # Changing field 'Order.order_type'
        db.alter_column(u'orders_order', 'order_type', self.gf('django.db.models.fields.CharField')(max_length='100', null=True))
