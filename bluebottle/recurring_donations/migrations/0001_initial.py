...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'recurring_donations', ['MonthlyDonor'])

        # Adding model 'MonthlyDonorProject'
        ...
        # Adding model 'MonthlyBatch'
        db.create_table(u'recurring_donations_monthlybatch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal(u'recurring_donations', ['MonthlyBatch'])

        # Adding model 'MonthlyProject'
        ...
        # Adding model 'MonthlyOrder'
        db.create_table(u'recurring_donations_monthlyorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ...
            ('error', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal(u'recurring_donations', ['MonthlyOrder'])
    ...
    def backwards(self, orm):
        # Deleting model 'MonthlyDonor'
        db.delete_table(u'recurring_donations_monthlydonor')

        # Deleting model 'MonthlyDonorProject'
        db.delete_table(u'recurring_donations_monthlydonorproject')

        # Deleting model 'MonthlyBatch'
        db.delete_table(u'recurring_donations_monthlybatch')

        # Deleting model 'MonthlyProject'
        db.delete_table(u'recurring_donations_monthlyproject')

        # Deleting model 'MonthlyOrder'
        db.delete_table(u'recurring_donations_monthlyorder')

        # Deleting model 'MonthlyDonation'
        db.delete_table(u'recurring_donations_monthlydonation')
    ...
    models = {
        ...
        u'recurring_donations.monthlybatch': {
            'Meta': {'object_name': 'MonthlyBatch'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
    ...
    complete_apps = ['recurring_donations']