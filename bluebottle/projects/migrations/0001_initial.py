...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_project', (
            ...
            ('amount_asked', self.gf('bluebottle.projects.fields.MoneyField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('amount_donated', self.gf('bluebottle.projects.fields.MoneyField')(default=0, max_digits=12, decimal_places=2)),
            ('amount_needed', self.gf('bluebottle.projects.fields.MoneyField')(default=0, max_digits=12, decimal_places=2)),
